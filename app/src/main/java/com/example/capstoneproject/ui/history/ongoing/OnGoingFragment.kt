package com.example.capstoneproject.ui.history.ongoing
...
import com.example.capstoneproject.databinding.FragmentOnGoingBinding
    ...
    private fun getHistoryTransaction(idUser: String) {
        ...
        db.collection("transaction")
            ...
            .addOnSuccessListener { querySnapshot ->
                ...
                viewModel.getAllHistoryTransactionOnGoing(listOrder)
